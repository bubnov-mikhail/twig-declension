...
use BubnovKelnik\TwigDeclensionBundle\Form\Type\DeclensionType;
use BubnovKelnik\TwigDeclensionBundle\Form\Type\FilterDeclensionFormType;
...
class DeclensionController extends Controller
{
     ...
     * @Template("BubnovKelnikTwigDeclensionBundle:Declension:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('BubnovKelnikTwigDeclensionBundle:Declension')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Secure(roles="ROLE_ADMIN")
     * @Template("BubnovKelnikTwigDeclensionBundle:Declension:edit.html.twig")
     */
    ...
    public function indexAction()
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $qb = $em->getRepository('BubnovKelnikTwigDeclensionBundle:Declension')->getListQB($formData);
